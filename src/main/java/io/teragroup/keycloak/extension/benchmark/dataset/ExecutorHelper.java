...
public class ExecutorHelper {
    ...
    public void addTaskRunningInTransaction(KeycloakSessionTask sessionTask) {
        Future f = executor.submit(() -> KeycloakModelUtils.runJobInTransactionWithTimeout(sessionFactory, sessionTask,
    ...
    public void waitForAllToFinish() throws ExecutionException, InterruptedException {
        ...
        for (Optional<Future> runningTask = getFirstRunningTask(); runningTask
                .isPresent(); runningTask = getFirstRunningTask()) {
