...
package io.teragroup.keycloak.extension.benchmark.cache;
...
public class CacheResourceProvider implements RealmResourceProvider {
    ...
    private static final String[] CACHE_NAMES = Stream.of(CORE_CACHE_NAMES, SESSION_CACHE_NAMES).flatMap(Stream::of)
            .toArray(String[]::new);
