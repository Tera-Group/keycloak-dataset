...
public class ConfigUtil {
     ...
     * @return
     */
    public static DatasetConfig createConfigFromQueryParams(UriInfo uriInfo, DatasetOperation operation) {
        ...
        for (Field f : DatasetConfig.class.getDeclaredFields()) {
            ...
            if (qpf != null) {
                ...
                String val = uriInfo.getQueryParameters().getFirst(qpf.paramName());
                if (val == null) {
                    if (qpf.required()) {
            ...
            if (qpfInt != null) {
                ...
                String valStr = uriInfo.getQueryParameters().getFirst(qpfInt.paramName());
                Integer val;
                if (valStr == null) {
                    if (qpfInt.required()) {
     ...
     *
     * For example if there are already realms "realm0, realm1, ... realm157", then
     * this method will return 158, which means
