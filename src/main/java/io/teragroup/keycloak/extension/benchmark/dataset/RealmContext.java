...
/**
 * Collection of objects, which were created and are related to the particular
 * realm. This collection is "maintained" here to avoid
 * DB lookups as much as possible...
 *
 * Caller should expect that many model instances obtained here should NOT be
 * used for WRITE as they might be loaded to different transaction.
 *
